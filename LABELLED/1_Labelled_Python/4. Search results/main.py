...
##   - installing selenium
##   - downloading chrome driver (https://chrome
# .chromium.org/downloads)
##   - once you install chrome driver, go to functions.py (in this directory) and enter the path of chromedriver
...
if what_to_do == 'help' or what_to_do == "'help'":
    ...
    print("- downloading chrome driver (https://chromedriver.chromium.org/downloads)")
    print(" - once you install chrome driver, go to functions.py (in this directory) and enter the path of chromedriver. In the functions.py file there are more instructions to how to do so.")
    exit()
